...
PM_START_STICKER = "CAACAgUAAxkBAAIHIWE8SN1EYVJgH-SikeN11hyp3vvFAAJoAwACpN3hVY-_RaBzX8DZIAQ"
PM_START_TEXT = """
ʜᴇʟʟᴏ, ɪ ᴀᴍ ᴋɪɴɢꜱᴛᴇʀ ❤️	

ɪ ᴀᴍ ᴘᴏᴡᴇʀꜰᴜʟʟ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇʀ ʙᴏᴛ ꜰʀᴏᴍ ᴄᴏᴏʟ ᴍᴏᴅᴜᴀʟꜱ. ɪ ᴄᴀɴ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴜꜱᴇꜰᴜʟʟ ꜰɪᴜᴛᴜʀᴇꜱ. ꜰᴇᴇʟ ꜰᴇᴇ ᴛᴏ ᴀᴅᴅ ᴍᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ 🥳
"""
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="🍀 ɪɴꜰᴏ ᴀɴᴅ ᴀʙᴏᴜᴛ 🍀", callback_data="aboutmenu_")
    ],
    [
        InlineKeyboardButton(text="🔔 ᴄʜᴀɴɴᴀʟ 🔔", url="t.me/kingster_updates"),
    
        InlineKeyboardButton(text="👥 ꜱᴜᴘᴘᴏʀᴛ 👥", url="t.me/kingster_support"),
    ],      
    [
        InlineKeyboardButton(
            text="🏆 ᴀᴅᴅ ᴋɪɴɢꜱᴛᴇʀ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕", url="t.me/szkingster_bot?startgroup=true"
        ),
    ],
]
...
HELP_STRINGS = f"""
**👻 ᴋɪɴɢꜱᴛᴇʀ ʙᴏᴛ ᴍᴀɪɴ ᴄᴏᴍᴍᴀɴᴅꜱ 👻**

  /start = ɪ ᴀᴍ ᴀʟɪᴠᴇ ᴏʀ ɴᴏ 🍀
  /help = ɢᴇᴛ ʜᴇʟᴘ ᴍᴇɴᴜ 🍀
  /donate = ᴅᴏɴᴀᴛᴇ ꜱᴛʀɪɴɢ 🍀
  
 ❤️ ꜰᴇᴇʟ ꜰᴇᴇ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ❤️
""".format(
...
DONATE_STRING = """🍀 ʜᴇʏᴀ ɢʟᴀᴅ ʏᴏᴜ ᴡᴀɴᴛ ᴅᴏɴᴀᴛᴇ! ᴅᴏɴᴀᴛᴇꜱ ᴏꜰ ᴏʀɢɪɴᴀʟ ᴡʀɪᴛᴇ'ꜱ ʙʏ [Channal](https://t.me/szteambots) 🍀,"""

SYSTEM_STRING = """✨ @szkingster_bot BY @omindas Gladers ✨,"""
...
def DaisyX_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*😍 Hi again!  The name's {dispatcher.bot.first_name} 😍 \n\nAs  You I'm a next generational group management bot developed by SZ Bots* "
            f"\n\n 🔥 Join [SZ bots](https://t.me/szbots) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [Kingster](https://github.com/omindadelshan/Max-Robot)."
            f"\n\n{dispatcher.bot.first_name}'s source code was written by Ominda"
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "I am now Working 🥳!")
        except Unauthorized:
            LOGGER.warning(
    ...
    system_handler = CommandHandler("system", donate)
